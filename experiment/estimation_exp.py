...
blank1 = CommandableImageSprite(screen, 
	(screen.get_width()*0.4, screen.get_height() * 0.5),
				 blank_image)
blank2 = CommandableImageSprite(screen, 
	(screen.get_width()*0.6, screen.get_height() * 0.5),
				 blank_image)
...
def present_trial(num_dots, max_time = 1):
	...
	dos = OrderedUpdates([static, blank1, blank2, blank3, request])
